...
use super::{
    AUTHENTICATOR_STATE_CREATE, AUTHENTICATOR_STATE_MODULE_NAME, BRIDGE_CREATE, BRIDGE_MODULE_NAME,
    CLOCK_MODULE_NAME, ID_LEAK_DIAG, OBJECT_MODULE_NAME, OBJECT_NEW_UID_FROM_HASH,
    RANDOMNESS_MODULE_NAME, RANDOMNESS_STATE_CREATE, SUI_ADDR_NAME, SUI_CLOCK_CREATE,
...
pub const FUNCTIONS_TO_SKIP: &[(Symbol, Symbol, Symbol)] = &[
    ...
    (SUI_ADDR_NAME, BRIDGE_MODULE_NAME, BRIDGE_CREATE),
];
